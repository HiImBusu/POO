package Examenes._19JunioPatinetes;

import Examenes._19JunioPatinetes.Solucion.Empresa;
import Examenes._19JunioPatinetes.Solucion.PatinetesException;
...
public class Main1 {
	...
	public static void main(String[] args) {
		...
		try {
			Empresa empresa = new Empresa("Aliquindoi", "src\\main\\java\\Examenes\\_19JunioPatinetes\\patinetes.txt");
