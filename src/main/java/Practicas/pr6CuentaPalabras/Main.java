package Practicas.pr6CuentaPalabras;

import Practicas.pr6CuentaPalabras.Solucion.ContadorPalabras;
import Practicas.pr6CuentaPalabras.Solucion.ContadorPalabrasSig;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            contadorSigFich.leeFicheroNoSig("src\\main\\java\\Practicas\\pr6CuentaPalabras\\fichNoSig.txt", delimitadores);
        ...
        try {
            ...
            contador.incluyeTodasFichero("src\\main\\java\\Practicas\\pr6CuentaPalabras\\datos.txt", delimitadores);
            contadorSigFich.incluyeTodasFichero("src\\main\\java\\Practicas\\pr6CuentaPalabras\\datos.txt", delimitadores);
            System.out.println(contador + "\n");
            System.out.println(contadorSigFich + "\n"); //métodos para presentar por pantalla
            PrintWriter pw = new PrintWriter(System.out, true);
            contador.presentaPalabras(pw);
            //salida a fichero
            contador.presentaPalabras("src\\main\\java\\Practicas\\pr6CuentaPalabras\\salida.txt");
